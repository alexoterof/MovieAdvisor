package com.alexoterof.movieadvisor;
...
import com.alexoterof.movieadvisor.service.FilmQueryService;
import com.alexoterof.movieadvisor.service.FilmService;

//Haria lo que un controlador pero no estamos en una aplicacion web
@Component
public class MovieAdvisorRunApp {
	...
	public void run(String[] args) {
		...
		} else if (args.length % 2 != 0) { //A partir de aqui todos los argumentos tienen que ir por parejas
			System.out.println("Error de sintaxis");
			System.out.println(help.getHelp());
